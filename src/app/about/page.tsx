  ...
  return (
    <MarketingShell>
      <MarketingHero
        ...
        lede={`Diven built Music Practice for his own nightly practice, because every piano and guitar app he tried scored how closely he played a song against a reference, streaks and stars included, without ever telling him what to actually work on next. This one always knows the next skill and explains why it matters before you drill it.`}
      />
      ...
      <MarketingSection id="open-source" title="Free, open source, and no account">
        <p>
          ...
          start practicing immediately and it is still there tomorrow. If you want your progress on two devices,
          an optional sign-in adds cloud sync on top of the same local data. It is opt-in, and the app works
      ...
      <MarketingSection id="stack" title="The stack">
        <p>
          ...
          skill tree engine, so adding drums did not mean rewriting how piano or guitar work.
        </p>
      </MarketingSection>
      ...
      <MarketingSection id="feedback" title="Feedback">
        <p>
          ...
          me what confused you or what you wished it did next. The repo is open and issues are welcome at{" "}
