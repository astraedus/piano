...
describe("GUITAR_NODES form a coherent DAG", () => {
  it("has the full plan §2.4 node set plus the curriculum transition + capo + batch-3a/3b nodes (36)", () => {
    ...
    // g-t2-noise-control, and g-t2-mini-barre (→33); batch 3b adds g-t2-blues-note,
    // g-t2-bend-half, and g-t1-drive (→36).
    expect(GUITAR_NODES.length).toBe(36);
  });
